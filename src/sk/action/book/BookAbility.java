...
public enum BookAbility implements Ability {
	...
	BALANCED_STRIKE(AbilityStyle.ATTACK, AbilityType.ULTIMATE, 85, 14, 16548, 14710, 120),
	...
	REJUVENATE(AbilityStyle.DEFENCE, AbilityType.ULTIMATE, 52, 11, 14229, 179, 300),
